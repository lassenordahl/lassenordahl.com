...
function Layout({ children }) {
  return (
    <>
      ...
      <div className="app flex flex-col font-sans items-center min-h-screen bg-main landing">
        <div className="flex flex-col w-4/5 lg:w-1/2 min-h-screen landing-content">
          <Header />
